...
namespace QLNS
{
    public partial class frmbangcong : Form
    {
        ...
        private void frmbangcong_Load(object sender, EventArgs e)
        {
            ...
            Con.ConnectionString = @"Data Source=ADMIN\BINCHANHKUN99;Initial Catalog=QLNS;Integrated Security=True";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            float luong = ((lcb / 26) * nc + (lt * 40000) + pc + pck + th - kl);//luong co ban / 26 * ngay cong + (so gio lam them *40k) + phu cap+pckhac+thuong-kiluat
            txt52.Text = luong.ToString();
        }
