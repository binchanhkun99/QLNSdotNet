...
namespace QLNS
{
    public partial class frmphongban : Form
    {
        ...
        {
              string del2 = "delete from TblPhongBan where MaBoPhan = N'" + comboBox1.Text + "' AND MaPhong=N'" + textBox2.Text + "' ";
              string del = "delete from TblPhongBan where MaPhong=N'" + textBox2.Text + "'";
              string del1 = "delete from TblTTNVCoBan where MaBoPhan=N'" + comboBox1.Text + "'";
